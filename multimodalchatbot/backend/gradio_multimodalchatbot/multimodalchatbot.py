...
def import_component_and_data(
    ...
    try:
        for component in utils.get_all_components():
            if component_name == component.__name__ and isinstance(component, ComponentMeta):
                return component
...
class MultimodalChatbot(Component):
    ...
    def __init__(
        self,
        value: list[list[str | GradioComponent | tuple[str] | tuple[str | Path, str] | None]] | Callable | None = None,
        *,
        label: str | None = None,
    ...
    def _preprocess_chat_messages(
        ...
        if chat_message is None:
            ...
            capitalized_component = chat_message.component.upper() if chat_message.component in ("json", "html") else chat_message.component.capitalize()
            ...
            if component is not None:
                ...
                raise ValueError(f"Invalid component for MultimodalChatbot component: {chat_message.component}")
        else:
    ...
    def _postprocess_chat_messages(self, chat_message: MultimodalMessage | dict | None) -> MultimodalMessage | None:
        if chat_message is None:
            return None
