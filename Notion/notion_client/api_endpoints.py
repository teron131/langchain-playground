    ...
    def update(self, block_id: str, **kwargs: Any) -> SyncAsync[Any]:
        ...
        *[🔗 Endpoint documentation](https://developers.notion.com/reference/update-a-block)*
        ...
        return self.parent.request(
            ...
            method="PATCH",
            body=pick(kwargs, "embed", "type", "archived", "bookmark", "image", "video", "pdf", "file", "audio", "code", "equation", "divider", "breadcrumb", "table_of_contents", "link_to_page", "table_row", "heading_1", "heading_2", "heading_3", "paragraph", "bulleted_list_item", "numbered_list_item", "quote", "to_do", "toggle", "template", "callout", "synced_block", "table"),
            auth=kwargs.get("auth"),
        )
...
class DatabasesEndpoint(Endpoint):
    ...
    def retrieve(self, database_id: str, **kwargs: Any) -> SyncAsync[Any]:
        ...
        *[🔗 Endpoint documentation](https://developers.notion.com/reference/retrieve-a-database)*
        """
        return self.parent.request(path=f"databases/{database_id}", method="GET", auth=kwargs.get("auth"))
...
class UsersEndpoint(Endpoint):
    ...
    def retrieve(self, user_id: str, **kwargs: Any) -> SyncAsync[Any]:
        ...
        *[🔗 Endpoint documentation](https://developers.notion.com/reference/get-user)*
        """
        return self.parent.request(path=f"users/{user_id}", method="GET", auth=kwargs.get("auth"))
    ...
    def me(self, **kwargs: Any) -> SyncAsync[Any]:
        ...
        *[🔗 Endpoint documentation](https://developers.notion.com/reference/get-self)*
        """
        return self.parent.request(path="users/me", method="GET", auth=kwargs.get("auth"))
